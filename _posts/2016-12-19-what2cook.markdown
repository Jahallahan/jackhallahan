...
![Weekly meal plan on laptop screen]({{ site.baseurl }}/assets/what2cook_image2.png){: .center .db}
...
![Tablet view of recipe]({{ site.baseurl }}/assets/what2cook_image4.png){: .center .db }
